...
const demoMembers: TeamMember[] = [
  { id: 'tm-1', email: 'alban@byrå.se', name: 'Alban', avatarUrl: '', role: 'member', active: true, permissions: { contacts: true, projects: true, billing: false, settings: false, googleAds: false, reports: true } },
  { id: 'tm-2', email: 'kevin@byrå.se', name: 'Kevin', avatarUrl: '', role: 'member', active: true, permissions: { contacts: true, projects: true, billing: false, settings: false, googleAds: true, reports: true } },
  { id: 'tm-3', email: 'roine@byrå.se', name: 'Roine', avatarUrl: '', role: 'manager', active: true, permissions: { contacts: true, projects: true, billing: true, settings: true, googleAds: true, reports: true } },
  { id: 'tm-4', email: 'therese@byrå.se', name: 'Therese', avatarUrl: '', role: 'member', active: true, permissions: { contacts: true, projects: true, billing: false, settings: false, googleAds: false, reports: true } },
  { id: 'tm-5', email: 'dan@byrå.se', name: 'Dan', avatarUrl: '', role: 'member', active: true, permissions: { contacts: true, projects: true, billing: false, settings: false, googleAds: true, reports: true } },
  { id: 'tm-6', email: 'skhodran@byrå.se', name: 'Skhodran', avatarUrl: '', role: 'member', active: true, permissions: { contacts: true, projects: true, billing: false, settings: false, googleAds: true, reports: true } },
  ...
  { id: 'tm-8', email: 'ulf@byrå.se', name: 'Ulf', avatarUrl: '', role: 'manager', active: true, permissions: { contacts: true, projects: true, billing: true, settings: true, googleAds: true, reports: true } },
  { id: 'tm-9', email: 'elin@byrå.se', name: 'Elin', avatarUrl: '', role: 'manager', active: true, permissions: { contacts: true, projects: true, billing: true, settings: false, googleAds: true, reports: true } },
  { id: 'tm-10', email: 'anell@byrå.se', name: 'Anell', avatarUrl: '', role: 'member', active: true, permissions: { contacts: true, projects: true, billing: false, settings: false, googleAds: false, reports: true } },
  { id: 'tm-11', email: 'hussein@byrå.se', name: 'Hussein', avatarUrl: '', role: 'member', active: true, permissions: { contacts: true, projects: true, billing: false, settings: false, googleAds: true, reports: true } },
];
